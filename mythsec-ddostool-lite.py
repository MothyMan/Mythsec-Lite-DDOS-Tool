...
banner = Fore.RED+"""    __  ___      __  __                  
   /  |/  /_  __/ /_/ /_  ________  _____
  / /|_/ / / / / __/ __ \/ ___/ _ \/ ___/
 / /  / / /_/ / /_/ / / (__  )  __/ /__  
/_/  /_/\__, /\__/_/ /_/____/\___/\___/  
       /____/                            

DDoS Attack Tool (LITE VERSION)
"""
print(banner)
...
print(Fore.GREEN+"Nothing to see here lulz")
print(Fore.RED+"In normal mode, this tool shuts down the site in 30 to 1 minute after running it. If the site does not shut down, it needs to be bypassed. Use a bot or rooted version")
time.sleep(3)
...
"Mozilla/5.0 (Symbian/3; Series60/5.2 NokiaE7-00/010.016; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML, like Gecko) Version/3.0BrowserNG/7.2.7.3 3gpp-gba",
